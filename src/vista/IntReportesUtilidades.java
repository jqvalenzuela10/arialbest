...
public class IntReportesUtilidades extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IntReportesUtilidades frame = new IntReportesUtilidades();
	...
	public IntReportesUtilidades() {
		...
		JLabel lblCobranzasPendientes = new JLabel("Utilidades Por Venta");
		...
		chckbxMostrarDetalle.setBounds(31, 573, 218, 23);
		...
		JCheckBox chckbxPorCategoria = new JCheckBox("Por categoria");
		chckbxPorCategoria.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 13));
		chckbxPorCategoria.setBounds(31, 361, 143, 23);
		...
		chckbxPorLinea.setBounds(31, 395, 143, 23);
		...
		chckbxPorMarca.setBounds(31, 431, 143, 23);
		getContentPane().add(chckbxPorMarca);
		
		JCheckBox chckbxPorProducto = new JCheckBox("Por producto");
		chckbxPorProducto.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 13));
		chckbxPorProducto.setBounds(31, 467, 143, 23);
		...
		textField.setBounds(211, 361, 417, 20);
		getContentPane().add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(211, 395, 417, 20);
		getContentPane().add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(211, 431, 417, 20);
		getContentPane().add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(211, 467, 417, 20);
