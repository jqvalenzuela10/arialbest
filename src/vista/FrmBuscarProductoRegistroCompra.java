...
public class FrmBuscarProductoRegistroCompra extends JDialog {
	...
	public static void main(String[] args) {
		try {
			FrmBuscarProductoRegistroCompra dialog = new FrmBuscarProductoRegistroCompra();
	 ...
	 * Create the dialog.
	 */
	public FrmBuscarProductoRegistroCompra() {
		/*agregar al carrito*/
		...
		lblNewLabel.setIcon(new ImageIcon(FrmBuscarProductoRegistroCompra.class.getResource("/iconos/Producto.png")));
