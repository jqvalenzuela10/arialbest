...
public class IntReportesCompras extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IntReportesCompras frame = new IntReportesCompras();
	...
	public IntReportesCompras() {
		...
		JLabel lblCobranzasPendientes = new JLabel("Compras");
		...
		JCheckBox chckbxMostrarDetalle = new JCheckBox("Mostrar Detalle de cada Compra");
		chckbxMostrarDetalle.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 13));
		chckbxMostrarDetalle.setBounds(31, 573, 246, 23);
		...
		JCheckBox chckbxPorCategoria = new JCheckBox("Por Proveedor");
		...
		JCheckBox chckbxPorLinea = new JCheckBox("Por Producto");
		...
		JCheckBox chckbxPorMarca = new JCheckBox("Por Usuario");
